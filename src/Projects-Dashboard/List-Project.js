    ...
    >
      <div className="title-container mb-10">
        <h1 className="text-5xl font-light mb-6">
          List of Projects & Display Modes
        </h1>
        <div className="section1 mb-6 flex items-start">
          <div className="w-1/2 pr-8">
            ...
            <p className="mb-4">
              To explore and customize the list of projects and their display
              modes, follow these instructions:
            </p>
            <div className="instructions pl-4">
              ...
              <ul className="list-disc pl-8 mb-4">
                <li className="mb-2">Table</li>
                <li className="mb-2">Board</li>
                <li className="mb-2">Grid</li>
                <li className="mb-2">Chart</li>
              </ul>
              <p className="mb-2">
                4. You can also change the way tasks and subtasks are displayed
                to one of the above modes.
              </p>
            </div>
          </div>
          {/* Images */}
          <div className="w-2/5">
            <div className="image-wrapper mb-4 mt-2">
              <img
                src="/imges/list_projects.jpg"
      ...
      <div className="video-wrapper mb-10 text-left mt-40">
        <video
          src="/video/List_project.mp4"
          poster="/imges/poster_display.png"
          controls
          loop

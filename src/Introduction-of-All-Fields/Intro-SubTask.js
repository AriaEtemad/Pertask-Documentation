...
const SubtaskFieldsIntroduction = () => {
      ...
      <div className="title-container mb-10">
        ...
        <section className="space-y-4">
          <div className="section2">
            ...
            <p className="p2">Each subtask has a title.</p>
            <p className="p2">This field is required.</p>

            <p className="p1">2. Active</p>
            <p className="p2">
              You can set the status of the current subtask to active or
              inactive.
            </p>
            <p className="p2">
              When the subtask status is set to inactive, that subtask and all
              related activities will be visible only.
            </p>

            <p className="p1">3. State</p>
            <p className="p2">
              Each subtask has a current status. You can select a status from
              the drop-down list.
            </p>
            <p className="p2">
            ...
            <p className="p2">
              Each subtask has a priority. You can select a priority from the
              drop-down list.
            </p>
            <p className="p2">
              This list is created when the project is defined.
            ...
            <p className="p2">
              You can define a deadline for the current subtask.
            </p>
            <p className="p2">
              If you leave this field blank, the subtask will not have a
              deadline.
            </p>

            <p className="p1">6. Ticket Count</p>
            <p className="p2">
              You should make an initial estimate of the required amount of work
              to perform this subtask by selecting the type and number of
              tickets you want.
            </p>
            <p className="p2">
            ...
            <p className="p2">
              The types of tickets that can be used for the current subtask are
              specified when the project is defined.
            </p>

            <p className="p1">7. Prefixes</p>
            <p className="p2">
              A subtask can be related to several different projects. For this
              purpose, you must choose a prefix for the current task.
            </p>
            <p className="p2">
              The list of prefixes that can be selected for the current subtask
              is specified when the project is defined.
            </p>

            <p className="p1">8. Tags</p>
            <p className="p2">
              You can select one or more tags for the current subtask.
            </p>
            <p className="p2">
              Tagging subtasks provides the ability to filter and also report on
              them.
            </p>
            <p className="p2">
              The list of tags that can be used for the current subtask is
              specified when the project is defined.
            </p>

            <p className="p1">9. Types</p>
            <p className="p2">
              All performed activities on subtasks should be saved in relation
              to a specific type of work. You can select a list of usable types
              for this task.
            </p>
            <p className="p2">
              The list of types that can be used for the current subtask is
              specified when the project is defined.
            </p>

            <p className="p1">10. Descriptions</p>
            <p className="p2">
              You can insert any description about the subtask. By using the
              text editor, you can edit text, insert files, images, links, etc.
            </p>

            <p className="p1">12. User</p>
            <p className="p2">
              You can see the list of all users and choose one.
            </p>
            <p className="p2">
              You will only be able to choose from the users who have been added
              to the current project.
            </p>

            <p className="p1">13. Member Type</p>
            <p className="p2">
              You can specify the type of user membership in the current task.
            </p>
            <p className="p2">
              The difference between “User” and “Client” is the ability to view
              the list of activities. Clients cannot see the list of activities.
            </p>

            <p className="p1">14. Access Type</p>
            <p className="p1">
              <strong>Note :</strong> You can specify the user's access level in
              the project. There are 4 levels of access:
            </p>
            ...
            <p className="p5">
              <strong>Edit:</strong>Projects cannot be deleted by the user. User
              cannot delete the tasks and comments of another user. Under time
              restrictions, the user can remove their own comments.
            </p>
...
export default SubtaskFieldsIntroduction;

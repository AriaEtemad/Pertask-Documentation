...
const LogsAndDevices = () => {
  ...
  const images = ["/imges/logs1.jpg", "/imges/logs3.jpg", "/imges/logs2.jpg"];
  ...
  return (
    ...
    >
      <div className="title-container mb-10">
        <h6 className="text-5xl font-light mb-6">Logs & Linked Devices</h6>
        <div className="section1 mb-6 flex items-start">
          <div className="w-1/2 pr-8">
            <h3 className="text-xl font-medium mb-4">Linked Devices</h3>
            <p className="mb-4">
              You can see all performed activities with your account:
            </p>
            <div className="instructions pl-4">
              ...
              <p className="mb-2">
                3. Select <strong>Audit Logs</strong>.
              </p>
            </div>
            <div className="section2 mt-12">
              <p className="mb-4">
                You can also see the list of all the devices through which you
                have signed in to the program:
              </p>
              <div className="instructions pl-4">
                ...
                <p className="mb-2">
                  2. Select <strong>Devices</strong>.
                </p>
              </div>
            </div>
          </div>

...
const DeleteSubtask = () => {
  ...
  const images = [
    "/imges/deletesub1.jpg",
    "/imges/deletesub2.jpg",
    "/imges/deletesub3.jpg",
    "/imges/deletesub4.jpg",
  ];
    ...
    >
      <div className="title-container mb-10">
        <h6 className="text-5xl font-light mb-6">
          Delete a Subtask in Pertask
        </h6>
        <div className="section1 mb-6 flex items-start">
          <div className="w-1/2 pr-8">
            <h3 className="text-xl font-medium mb-3">Delete Subtask</h3>
            <p className="mb-4">
              To remove a Subtask, please follow these steps carefully:
            </p>
            <div className="instructions pl-4 mb-2">
              ...
              <p className="mb-2 mt-36">
                6. On the <strong>Subtasks</strong> page, find your subtask row.
              </p>
              <p className="mb-2">
                7. In the <strong>Title</strong> column, click on the three dots
                icon.
              </p>
              <p className="mb-2">
                8. Click on the <strong>Delete</strong> icon.
              </p>
              <p className="mb-2 mt-4">
                If the subtask has one of the following, it is not possible to
                delete it:
              </p>
            ...
            <div className="image-wrapper mb-10">
              {images.map((image, index) => (
                <img
                  key={index}
                  src={image}
                  alt={`Deleting a subtask step ${index + 1}`}
      ...
      <div className="video-wrapper mb-10 text-left">
        <video
          src="/video/delete_sub.mp4"
          poster="/imges/poster_deletesub.png"
          controls
          loop

  ...
  return (
    ...
    >
      <div className="title-container mb-10">
        <h6 className="text-5xl font-light mb-6">Edit a Subtask in Pertask</h6>
        <div className="section1 mb-6 flex items-start">
          <div className="w-1/2 pr-8">
            <h3 className="text-xl font-medium mb-3">Edit Subtask</h3>
            <p className="mb-4">
              By following these instructions you can edit your Subtask:
            </p>
      ...
      <div className="video-wrapper mb-10 text-left">
        <video
          src="/video/edit_sub.mp4"
          poster="/imges/poster_editsub.png"
          controls
          loop

...
const AssignMemberToTask = () => {
  ...
  const images = [
    "/imges/taskassign1.jpg",
    "/imges/taskassign2.jpg",
    "/imges/taskassign3.jpg",
    "/imges/taskassign4.jpg",
  ];
    ...
    >
      <div className="title-container mb-10">
        <h1 className="text-5xl font-light mb-6">
          Assign Member to Task and Grant Access
        </h1>
        <div className="section1 mb-6 flex items-start">
          <div className="w-1/2 pr-8">
            <h3 className="text-xl font-medium mb-4">Assign Member to Task</h3>
            <p className="mb-4">
              Follow these instructions to assign a member to a task and grant
              access :
            </p>
            <div className="instructions pl-4">
              ...
              <p className="mb-2">
                5. Click on <strong>Members</strong>.
              </p>
              <p className="mb-2 mt-40">
                6. Click on the <strong>Add New Member</strong> icon.
              </p>
              <p className="mb-2 mt-60">
                7. On the <strong>Members</strong> page, you can add a new user,
            ...
            <div className="image-wrapper mb-10">
              {images.map((img, index) => (
                <img
                  key={index}
                  src={img}
                  alt={`Assigning members to task step ${index + 1}`}
      ...
      <div className="video-wrapper mb-10 text-left">
        <video
          src="/video/assigntask.mp4"
          poster="/imges/poster_assigntask.png"
          controls
          loop

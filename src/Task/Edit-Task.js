  ...
  return (
    ...
    >
      <div className="title-container mb-10">
        <h6 className="text-5xl font-light mb-6">Edit a Task in Pertask</h6>
        <div className="section1 mb-6 flex items-start">
          <div className="w-1/2 pr-8">
            <h3 className="text-xl font-medium mb-3">Edit Task</h3>
            <p className="mb-4">
              By following these instructions you can edit your task:
            </p>
            <div className="instructions pl-4 mb-2">
              ...
              <p className="mb-2">
                6. Click on the <strong>Edit</strong> icon.
              </p>
              <p className="p1">
                <strong>Note:</strong> System administrators, managers, project
                creators, and users with <strong>Edit</strong> or{" "}
                <strong>Delete</strong> access can edit a task.
              </p>
            </div>
          </div>
          {/* Images */}
            ...
            <div className="image-wrapper mb-10">
              {images.map((image, index) => (
                <img
                  key={index}
                  src={image}
                  alt={`Editing a task step ${index + 1}`}
      ...
      <div className="video-wrapper mb-10 text-left">
        <video
          src="/video/taskedit.mp4"
          poster="/imges/poster_taskedit.png"
          controls
          loop

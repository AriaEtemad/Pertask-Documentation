...
const DeleteTask = () => {
  ...
  const images = [
    "/imges/taskdelete1.jpg",
    "/imges/taskdelete2.jpg",
    "/imges/taskdelete3.jpg",
  ];
  ...
  return (
    ...
    >
      <div className="title-container mb-10">
        <h6 className="text-5xl font-light mb-6">Delete a Task in Pertask</h6>
        <div className="section1 mb-6 flex items-start">
          <div className="w-1/2 pr-8">
            <h3 className="text-xl font-medium mb-3">Delete Task</h3>
            <p className="mb-4">
              To remove a task, please follow these steps carefully:
            </p>
            <div className="instructions pl-4 mb-2">
              ...
              <p className="mb-2">
                3. Click on the <strong>Title</strong>.
              </p>
              <p className="mb-2 mt-12">
                4. On the <strong>Task</strong> page, find your task row.
              </p>
              <p className="mb-2">
                5. In the <strong>Title</strong> column, click on the three dots
                icon.
              </p>
              <p className="mb-2">
                6. Click on the <strong>Delete</strong> icon.
              </p>
              <p className="mb-2 mt-4">
                If the task has any of the following, it cannot be deleted:
              </p>
              ...
              <p className="p1">
                ...
                creators, and users with <strong>Delete</strong> access can
                delete a task.
              </p>
            </div>
          </div>
            ...
            <div className="image-wrapper mb-10">
              {images.map((image, index) => (
                <img
                  key={index}
                  src={image}
                  alt={`Deleting a task step ${index + 1}`}
      ...
      <div className="video-wrapper mb-10 text-left">
        <video
          src="/video/taskdelete.mp4"
          poster="/imges/poster_deletetask.png"
          controls
          loop

...
const CreateTask = () => {
  ...
  const images = ["/imges/task1.jpg", "/imges/task2.jpg", "/imges/task3.jpg"];
  ...
  return (
    ...
    >
      <div className="title-container mb-10">
        <h6 className="text-5xl font-light mb-6">Create a Task in Pertask</h6>
        <div className="section1 mb-6 flex items-start">
          <div className="w-1/2 pr-8">
            <h3 className="text-xl font-medium mb-3">Create a New Task</h3>
            <p className="mb-4">
              To create a new Task, please follow these steps:
            </p>
            <div className="instructions pl-4 mb-2">
              ...
              <p className="mb-2 mt-14">
                4. On the <strong>Tasks</strong> page, you can see the list of
                all registered tasks for the current project.
              </p>
              <p className="mb-2">
                5. Click on the <strong>New</strong> icon.
              </p>
              <p className="mb-2 mt-32">
                6. On the <strong>Adding New Task</strong> page, complete the
                required fields:
              </p>
            ...
            <div className="image-wrapper mb-10">
              {images.map((image, index) => (
                <img
                  key={index}
                  src={image}
                  alt={`Creating a new task - Step ${index + 1}`}
      ...
      <div className="video-wrapper mb-10 text-left">
        <video
          src="/video/taskCreat.mp4"
          poster="/imges/poster_task.png"
          controls
          loop
      ...
      <div className="footer-links">
        ...
        <Link
          ...
          to="/Task/Assign-Task"
        >
          Assign members to Task and grant access
        </Link>
      </div>
